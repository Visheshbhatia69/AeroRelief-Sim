"""Experiment flow for one UAV placement simulation run."""
...
class ExperimentResult:
    """All outputs from one baseline-vs-optimized simulation run."""
...
def run_experiment(
    ...
    """Run one complete experiment: baseline placement, PSO, graphs, and metrics."""
...
def add_improvement_metrics(
    ...
    """Add graph-ready improvement and movement-efficiency values."""
