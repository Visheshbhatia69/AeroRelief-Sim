...
"""Placement methods used by the simulator, including PSO and K-Means."""
...
class ParticleSwarmOptimizer:
    """Particle Swarm Optimizer for UAV x/y placement."""
    ...
    def __init__(
        ...
        """Keep the scenario data and PSO parameters for one optimizer run."""
    ...
    def optimize(self) -> tuple[np.ndarray, float, list[float]]:
        """Run the swarm search and return the best placement found."""
        ...
        for _ in range(self.iterations):
            ...
            # This is PSO search velocity. It moves candidate solutions around
            # the search space; it is not treated as actual UAV flight speed.
            search_steps = (
    ...
    def _initialize_particles(self) -> np.ndarray:
        """Create the starting swarm of candidate UAV deployments."""
    ...
    def _objective(self, drones: np.ndarray) -> float:
        ...
        # Each term is normalized before weighting. Movement is subtracted so a
        # far-away repositioning plan must earn enough coverage benefit to be useful.
        return (
    ...
    def _coverage_ratio(self, drones: np.ndarray, grid_size: int = 25) -> float:
        """Estimate how much of the map falls inside a UAV ground footprint."""
        config = self.simulation.config
...
def kmeans_drone_placement(
    ...
    """K-Means baseline: place UAVs near user-cluster centres."""
